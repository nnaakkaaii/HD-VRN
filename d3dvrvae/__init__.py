...
cs.store(group="config/experiment/dataloader/dataset", name="mnist", node=MNISTDatasetOption)
cs.store(group="config/experiment/dataloader/transform", name="basic", node=BasicTransformOption)
...
cs.store(group="config/experiment/model/network", name="autoencoder2d", node=AutoEncoder2dNetworkOption)
cs.store(group="config/experiment/model/optimizer", name="adam", node=AdamOptimizerOption)
cs.store(group="config/experiment/model/scheduler", name="onecyclelr", node=OneCycleLRSchedulerOption)
